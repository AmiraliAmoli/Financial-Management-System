...
namespace Financial_Management_System
{
    partial class Reporting
    {
        ...
        private const string CostMonthlySummeryFilePath = @"C:\Users\amir\source\repos\Financial Management System\Financial Management System\obj\Debug\net8.0\transaction_cost.json";
        private const string IncomMonthlySummeryFilePath = @"C:\Users\amir\source\repos\Financial Management System\Financial Management System\obj\Debug\net8.0\transaction_icom.json";
        public void MonthlySummary()
        {
            ...
            string thirtyDayAgo = DateTime.Now.AddDays(-30).ToString("yyyy/MM/dd");

            Console.Clear();
            Console.ForegroundColor = ConsoleColor.Green;
            Console.WriteLine($"Summery:{NowDate} to {thirtyDayAgo}");
            ...
            while (NowDate != thirtyDayAgo)
            {
                ...
                NowDate = DateTime.Now.AddDays(-DayAgo).ToString("yyyy/MM/dd");
                DayAgo++;
            }
